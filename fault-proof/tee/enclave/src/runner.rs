...
use crate::{
    ...
    mem::{PeakTracker, trim_malloc, vm_rss_kb},
...
async fn execute_phases(
    ...
    // Ask glibc to return free arenas to the OS, then re-read RSS to see
    // how much was allocator caching vs really resident.
    trim_malloc();
    let rss_after_trim_kb = vm_rss_kb();
    ...
    info!(
        ...
        rss_after_trim_mib = rss_after_trim_kb / 1024,
