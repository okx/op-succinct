...
build-range-elfs:
    ...
    cd ../altda
    ~/.sp1/bin/cargo-prove prove build --elf-name altda-range-elf-embedded --docker --tag v6.1.0 --output-directory ../../../elf
...
build-tz-range-elf:
    ...
    ~/.sp1/bin/cargo-prove prove build --elf-name tz-range-elf-embedded --output-directory ../../../elf

build-tz-agg-elf:
    #!/usr/bin/env bash

    cd programs/tz/aggregation
    ~/.sp1/bin/cargo-prove prove build --elf-name tz-aggregation-elf --output-directory ../../../elf
