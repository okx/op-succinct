...
///         smoke test. `EXPECTED_POST_ANCHOR_ADDRESS` is required unless a development deployment
///         explicitly sets `ALLOW_UNVERIFIED_DEPLOYMENT=true`.
contract DeployPostAnchor is CrossChainDeploymentConfig {
    ...
    function run() public returns (address postAnchor) {
        ...
        address expected = _readExpectedAddress("EXPECTED_POST_ANCHOR_ADDRESS");
        ...
        _assertExpectedAddress(postAnchor, expected, "PostAnchor address mismatch");
    }
}
